	...
	<div class="background">
		...
		<?php while($row = mysqli_fetch_array($result)) { // loop through results of database query, displaying them in the table ?>
			...
			<div class="grid_item_link">
				...
				<a class="button revise" onclick="return confirm('Are you sure you want to delete: <?php echo $row["firstname"] . " " . $row["lastname"]; ?>?')" href="delete.php?id=<?php echo htmlspecialchars($row['id']); ?>">Delete</a></td>
